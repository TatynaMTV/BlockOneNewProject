...
extension UIColor {
    ...
    static func customBackColor() -> UIColor? {
        UIColor(red: 234/255, green: 237/255, blue: 232/255, alpha: 1)
    }
    
    static func charcoalGrey() -> UIColor? {
        UIColor(red: 73/255, green: 74/255, blue: 74/255, alpha: 1)
    }
    
    static func paleGrey() -> UIColor? {
        UIColor(red: 239/255, green: 243/255, blue: 246/255, alpha: 1)
    }
    
    static func lightGrey() -> UIColor? {
        UIColor(red: 232/255, green: 237/255, blue: 237/255, alpha: 1)
    }
    
    static func blueGrey() -> UIColor? {
        UIColor(red: 98/255, green: 127/255, blue: 143/255, alpha: 1)
    }
    
    static func darkSlateBlue() -> UIColor? {
        UIColor(red: 22/255, green: 59/255, blue: 79/255, alpha: 1)
    }
}
